    ...
    <div className="container-fluid equipe_hero my-5">
      ...
      <div className="row ">
        ...
        <div className="col-md-5">
          <h2 className="f32 fw-semibold">
            Sachel Rotge -{" "}
            <span className="f32 text-yellow  fw-semibold">
              Pilote automobile
            </span>
          </h2>
          <p className="f16 equipe_hero_text">
            ...
            en tant que pilote officiel. Je m’y prépare sans relâche, sans pour
            ...
            permis de vivre tant de moments extraordinaires…
          </p>
          <p className="sachel-sign">Sachel</p>
        </div>
      </div>
    </div>
  );
