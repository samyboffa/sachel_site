...
const EquipeHome = () => {
  return (
    <div className="container-fluid equipe_hero my-5">
      <h1 className="text-uppercase text-md-center text-sm-left my-5 fw-700 f56 lh-sm-base">
      ...
      <div className="row  ">
        ...
        <div className="col-md-6 col-sm-12">
          <h2 className="f32 fw-bold  text-uppercase ">
            ...
            <p className="my-5 fw-500 lh32 f16 manrope">J’ai 17 ans et je suis depuis toujours passionné de sport
            ...
            <p className="f16 manrope lh32 fw-500">Je m’y prépare sans relâche, sans pour
