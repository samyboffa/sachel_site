...
const Carousel = () => {
  return (
    <div className="container-fluid carousel-section my-5">
      <div
      ...
      >
        <div class="carousel-inner h-100  ">
          <h6 className="text-uppercase  temoignage-titre text-center text-yellow mt-5">
            temoignage
          </h6>
          {temoignage.map((temoigne, idx) => {
            return (
              <div key={idx} class="carousel-item active  ">
                <div className="temoignage mt-5">
                  <p className="text-temoignage text-light text-center w-50 text-uppercase mx-auto f32">
                    {temoigne.txt}
                  </p>
