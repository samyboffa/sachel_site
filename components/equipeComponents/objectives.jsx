...
const Objectifs = () => {
  return (
    <div className="container marginB-200 horizontal_objectif">
      <p className="termina600 f32 text-center marginB-200 text-noir text-uppercase  objectifs-titre">
        mes objectifs
      </p>
      <div className=" row d-flex aic jcc w-75 mx-auto my-5">
        <div className="circle circle-border border-yellow d-flex aic jcc p-0 m-0 rounded-circle ">
          <div className="inner-circle bg-yellow rounded-circle  "></div>
        </div>
        <span className="line "></span>
        <div className="circle circle-border border-noir d-flex aic jcc p-0 m-0 rounded-circle ">
      ...
      <div className="row text-center fw-bolder f40">
        ...
        <div className="col-md-4 d-flex flex-column gap-3">
          ...
          <p className="objectif_txt text-noir">
            ...
            ultime : participer aux prestigieuses
            <span className="manrope fw-700"> 24 heures du Mans.</span>
          </p>
        </div>
      </div>
    </div>
