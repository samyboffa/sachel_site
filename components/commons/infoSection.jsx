...
const InfoSection = ({
  ...
  return (
    <section
      className={
        reverse
          ? "row d-flex container justify-content-between marginB-200 mx-auto p-xs-3 flex-md-row-reverse   "
          : "row d-flex container justify-content-between p-xs-3 mx-auto marginB-200"
      }
    >
