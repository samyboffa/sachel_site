...
const Majeur = () => {
  ...
  return (
    <div className='container-fluid partenariat p-5 my-5 flex-xs-column gap-3 d-flex flex-md-row  jcc'>
        <div className="col-md-3 col-xs-12 bg-light p-4 h-75 d-flex flex-column jcsb">
            <div className='d-flex aic'>
                <span ><img src="./helmet.png" alt="hemlet" className="helmet" /></span>
                <p className=' text-noir text-uppercase termina600  f32 lh-sm   '>Sponsor majeur</p>
            </div>
        ...
        <div className="transparent col-xs-12 col-md-3 d-flex flex-column jcsb p-4 text-light">
            <div className="d-flex flex-column ">
              <p className='s text-uppercase termina600 f24 lh-sm  p-1 my-3 '>Sponsor</p>
              {Array2.map((item, idx) => 
                {
                   return <CheveronTxt item={item} key={idx} />;
                 })
            ...
            <CustomButton text="DEVENIR SPONSOR" link="#" style="mt-5 bg-light border-0 p-3 w-100 " />
        </div>
