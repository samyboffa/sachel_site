...
const Majeur = () => {
  ...
  return (
    <div className='container-fluid partenariat p-5 my-5 flex-sm-column gap-3 d-flex flex-md-row  jcc'>
        ...
        <div className="transparent col-md-4 d-flex flex-column jcsb p-4 text-light">
