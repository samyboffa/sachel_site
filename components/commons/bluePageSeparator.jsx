    ...
    <div className="blueSeparator container-fluid ">
      <div className="row d-flex">
        <div className="data col-md-6 col-sm-12 p-5 text-light ">
          <h5 className="termina600 f32 text-uppercase mb-md-5 mb-sm-4">{title}</h5>
          ...
          <div className={router.pathname === '/equipe' ? 'd-flex aic jcsb gap-2 mt-5' : 'd-none'}>
            <img src="./Calque_1.png" alt="KartMAg" />
            <p className="rock-salt my-0 f20 lh-32 p-3 fw-400">“le Français Sachel Rotgé a décroché une belle 9ème place ”</p>
          </div>
        </div>
